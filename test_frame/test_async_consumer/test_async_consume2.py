...
@task_deco('test_async_queue2', concurrent_mode=ConcurrentModeEnum.ASYNC, broker_kind=BrokerEnum.REDIS_LIST, log_level=10,
...
@task_deco('test_f_queue2', concurrent_mode=ConcurrentModeEnum.THREADING, broker_kind=BrokerEnum.REDIS_LIST, concurrent_num=500, log_level=10)
def f(y):
