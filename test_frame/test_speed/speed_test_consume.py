...
@task_deco('20000', broker_kind=BrokerEnum.REDIS_LIST, concurrent_num=2, log_level=20, qps=0, concurrent_mode=ConcurrentModeEnum.SINGLE_THREAD, )
def f_test_speed(x):
    pass
    # logger.debug(x)
...
# @task_deco('speed_test_queue2', broker_kind=BrokerEnum.REDIS_LIST, log_level=20, qps=2)
# def f_test_speed2(y):
#     pass
#     print(y)
